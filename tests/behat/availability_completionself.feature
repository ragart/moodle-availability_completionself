@availability @availability_completionself
Feature: availability_completion
  ...
  Scenario: Test condition
    ...
    And I click on "Self completion" "button" in the "Add restriction..." "dialogue"
  ...
  @javascript
  Scenario Outline: Restrict access for activity self completion should display correctly
